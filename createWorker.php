                    ...
                    <div class="container-xl col mid">
                        ...
                        <!-- ide kell a kozepso div címe, kozepre igazítva-->
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input id="lastNameInput" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                            </div>
                            <div class="input-group input-group-sm mb-3">
                                <span class="input-group-text" id="inputGroup-sizing-sm">Keresztnév</span>
                                <input id="firstNameInput" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                            </div>
